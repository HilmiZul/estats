  ...
  <div class="content">
    <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" style="isolation:isolate" viewBox="0 0 700 900" class="peta">
      ...
      <g clip-path="url(#_clipPath_33BetrrifSpbuoHPpqZQ8QOSHptk58aG)">
        ...
        <!-- ############################ LABEL ###########################-->
        <a href="?nav=stats&detil=true&kecamatan=PAKISJAYA&bulan=<?php print $bulan?>&bulan_end=<?php print $bulan_end?>">
        ...
        <a href="?nav=stats&detil=true&kecamatan=BATUJAYA&bulan=<?php print $bulan?>&bulan_end=<?php print $bulan_end?>">
        ...
        <a href="?nav=stats&detil=true&kecamatan=TIRTAJAYA&bulan=<?php print $bulan?>&bulan_end=<?php print $bulan_end?>">
        ...
        <a href="?nav=stats&detil=true&kecamatan=CIBUAYA&bulan=<?php print $bulan?>&bulan_end=<?php print $bulan_end?>">
        ...
        <a href="?nav=stats&detil=true&kecamatan=JAYAKERTA&bulan=<?php print $bulan?>&bulan_end=<?php print $bulan_end?>">
        ...
        <a href="?nav=stats&detil=true&kecamatan=PEDES&bulan=<?php print $bulan?>&bulan_end=<?php print $bulan_end?>">
        ...
        <a href="?nav=stats&detil=true&kecamatan=CILEBAR&bulan=<?php print $bulan?>&bulan_end=<?php print $bulan_end?>">
        ...
        <a href="?nav=stats&detil=true&kecamatan=TEMPURAN&bulan=<?php print $bulan?>&bulan_end=<?php print $bulan_end?>">
        ...
        <a href="?nav=stats&detil=true&kecamatan=RAWAMERTA&bulan=<?php print $bulan?>&bulan_end=<?php print $bulan_end?>">
        ...
        <a href="?nav=stats&detil=true&kecamatan=MAJALAYA&bulan=<?php print $bulan?>&bulan_end=<?php print $bulan_end?>">
        ...
        <a href="?nav=stats&detil=true&kecamatan=KLARI&bulan=<?php print $bulan?>&bulan_end=<?php print $bulan_end?>">
        ...
        <a href="?nav=stats&detil=true&kecamatan=PURWASARI&bulan=<?php print $bulan?>&bulan_end=<?php print $bulan_end?>">
        ...
        <a href="?nav=stats&detil=true&kecamatan=CIKAMPEK&bulan=<?php print $bulan?>&bulan_end=<?php print $bulan_end?>">
        ...
        <a href="?nav=stats&detil=true&kecamatan=TIRTAMULYA&bulan=<?php print $bulan?>&bulan_end=<?php print $bulan_end?>">
        ...
        <a href="?nav=stats&detil=true&kecamatan=JATISARI&bulan=<?php print $bulan?>&bulan_end=<?php print $bulan_end?>">
        ...
        <a href="?nav=stats&detil=true&kecamatan=BANYUSARI&bulan=<?php print $bulan?>&bulan_end=<?php print $bulan_end?>">
        ...
        <a href="?nav=stats&detil=true&kecamatan=CILAMAYA-WETAN&bulan=<?php print $bulan?>&bulan_end=<?php print $bulan_end?>">
        ...
        <a href="?nav=stats&detil=true&kecamatan=CILAMAYA-KULON&bulan=<?php print $bulan?>&bulan_end=<?php print $bulan_end?>">
        ...
        <a href="?nav=stats&detil=true&kecamatan=LEMAHABANG&bulan=<?php print $bulan?>&bulan_end=<?php print $bulan_end?>">
        ...
        <a href="?nav=stats&detil=true&kecamatan=KOTABARU&bulan=<?php print $bulan?>&bulan_end=<?php print $bulan_end?>">
        ...
        <a href="?nav=stats&detil=true&kecamatan=CIAMPEL&bulan=<?php print $bulan?>&bulan_end=<?php print $bulan_end?>">
        ...
        <a href="?nav=stats&detil=true&kecamatan=PANGKALAN&bulan=<?php print $bulan?>&bulan_end=<?php print $bulan_end?>">
        ...
        <a href="?nav=stats&detil=true&kecamatan=TEGALWARU&bulan=<?php print $bulan?>&bulan_end=<?php print $bulan_end?>">
        ...
        <a href="?nav=stats&detil=true&kecamatan=TELAGASARI&bulan=<?php print $bulan?>&bulan_end=<?php print $bulan_end?>">
        ...
        <a href="?nav=stats&detil=true&kecamatan=KARAWANG-BARAT&bulan=<?php print $bulan?>&bulan_end=<?php print $bulan_end?>">
        ...
        <a href="?nav=stats&detil=true&kecamatan=KARAWANG-TIMUR&bulan=<?php print $bulan?>&bulan_end=<?php print $bulan_end?>">
        ...
        <a href="?nav=stats&detil=true&kecamatan=TELUKJAMBE-BARAT&bulan=<?php print $bulan?>&bulan_end=<?php print $bulan_end?>">
        ...
        <a href="?nav=stats&detil=true&kecamatan=TELUKJAMBE-TIMUR&bulan=<?php print $bulan?>&bulan_end=<?php print $bulan_end?>">
        ...
        <a href="?nav=stats&detil=true&kecamatan=KUTAWALUYA&bulan=<?php print $bulan?>&bulan_end=<?php print $bulan_end?>">
        ...
        <a href="?nav=stats&detil=true&kecamatan=RENGASDENGKLOK&bulan=<?php print $bulan?>&bulan_end=<?php print $bulan_end?>">
