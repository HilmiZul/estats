...
if (isset($_POST['upload'])) {
  ...
  if(in_array($file_ext, $allowed_ext) == true) {
    ...
    $msg = "<div class='alert alert-success'><i class='ti-check'></i> DATA BERHASIL DI IMPOR.</div>";
  } else {
    $msg = "<div class='alert alert-danger'><i class='ti-na'></i> BERKAS TIDAK DIIJINKAN. SILAHKAN IMPOR BERKAS DENGAN TIPE .XLS</div>";
  }
}
?>
<div class="row">
